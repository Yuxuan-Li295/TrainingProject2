...
const currentVisaStepMap = {
  receipt: 'receiptStatus',  // OPT收据阶段
  ead_card: 'eadCardStatus',  // EAD卡阶段
  i983: 'i983Status',  // I-983表格阶段
  i20: 'i20Status',  // I-20表格阶段
}
  ...
  const columns: TableProps<DataType>['columns'] = [
    ...
    },
    {
      ...
      render: (_, record) => {
        ...
        return <Tag color="magenta">
          {!key || record?.onboardingStatus[key] === visaStepStatusEnum.NOT_SUBMITTED ? '未提交' : record?.onboardingStatus[key] === visaStepStatusEnum.SUBMITTED ? '已提交' : record?.onboardingStatus[key] === visaStepStatusEnum.APPROVED ? '已批准' : record?.onboardingStatus[key] === visaStepStatusEnum.REJECTED ? '已拒绝' : ''}
        </Tag>
      }
    },
    {
