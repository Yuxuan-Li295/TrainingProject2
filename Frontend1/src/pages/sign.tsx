  ...
  const columns: TableProps<DataType>['columns'] = [
    ...
    },
    {
      ...
      render: (_, record) => {
        return (
          <Image.PreviewGroup
            items={record?.documents.RECEIPT}
          >
            <Image
              width={50}
              ...
              src={record?.documents.RECEIPT?.[0]}
            />
          </Image.PreviewGroup>
        )
      }
    ...
    },
    {
      ...
      render: (_, record) => {
        return (
          <Image.PreviewGroup
            items={record?.documents.EAD_CARD}
          >
            <Image
              width={50}
              fallback="data:image/png;base64,"
              src={record?.documents.EAD_CARD?.[0]}
            />
          </Image.PreviewGroup>
        )
      }
    },
    {
      ...
      render: (_, record) => {
        return (
          <Image.PreviewGroup
            items={record?.documents.I983_FORM}
          >
            <Image
              width={50}
              fallback="data:image/png;base64,"
              src={record?.documents.I983_FORM?.[0]}
            />
          </Image.PreviewGroup>
        )
      }
    },
    {
      ...
      render: (_, record) => {
        return (
          <Image.PreviewGroup
            items={record?.documents.I20_FORM}
          >
            <Image
              width={50}
              fallback="data:image/png;base64,"
    ...
    },
    {
      ...
      render: (_, record) => {
        return (
          <Image.PreviewGroup
            items={record?.documents.OTHERS}
          >
            <Image
              width={50}
              fallback="data:image/png;base64,"
              src={record?.documents.OTHERS?.[0]}
            />
          </Image.PreviewGroup>
        )
      }
